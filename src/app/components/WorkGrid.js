    ...
    return (
        <animated.div className='grid grid-cols-1 lg:grid-cols-9 lg:grid-rows-9 w-screen lg:h-screen p-5 gap-5 bg-stone-200'>
            ...
            >
                ...
                >
                    <span className='text-white text-lg'>Note Taking</span>
                </animated.div>
            </animated.div>
            ...
            >
                <animated.div
                    style={trails[3]}
                    className='w-full h-full relative bg-[#A7C957] border border-black flex items-center justify-center'
                >
                    <span className='text-black text-lg'>Projects Overview</span>
                </animated.div>
            </animated.div>
            ...
            >
                ...
                >
                    <span className='text-white text-lg'>Education Background</span>
                </animated.div>
            </animated.div>
            ...
            >
                <animated.div
                    ...
                    className='w-full h-full relative bg-[#6A994E] border border-neutral-900 flex items-center justify-center'
                >
                    <span className='text-white text-lg'>Blog Highlights</span>
                </animated.div>
            </animated.div>
            ...
            >
                <animated.div
                    ...
                    className='w-full h-full relative bg-[#6A994E] border border-neutral-900 flex items-center justify-center'
                >
                    <span className='text-white text-lg'>Contact Me</span>
